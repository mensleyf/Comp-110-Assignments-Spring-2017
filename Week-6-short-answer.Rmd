...
# My computer was having a hard time working with the entire data set, so I separated it into a smaller subsection--this quite likely may change some of the answers (sorry!) but I hope you can see my methods. I will resubmit if possible later with complete data set!
